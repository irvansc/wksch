<div>
    <div class="row mt-3">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="d-flex">
                            <div class="me-3 mb-3">
                                ...
                                data-bs-target="#sliderprestasi_modal" type="button">
                                Add Slider
                            </a>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-vcenter card-table table-striped">
                            ...
                            <tbody id="sortable_sliderprestasi">
                                @forelse ($sliders as $slid)
                                <tr data-index="{{$slid->id}}" data-ordering="{{$slid->ordering}}">
                                    <td>
                                        <img src="storage/images/album/slider/prestasi/{{ $slid->img }}" alt="" style="width: 200px">
                                    </td>
                                    <td>
                                        {{ $slid->title }}
                                    </td>
      ...
      {{-- Modals --}}
      <div wire:ignore.self class="modal fade" id="sliderprestasi_modal" tabindex="-1" role="dialog"
      aria-labelledby="myLargeModalLabel" style="display: none;" aria-hidden="true">
      <div class="modal-dialog  modal-dialog-centered">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="myLargeModalLabel">
                      {{$updateSliderPrestasiMode ? 'Updated Slider Prestasi' : 'Add Slider Prestasi'}}
                  </h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <form class="modal-content" method="POST" @if ($updateSliderPrestasiMode)
                  wire:submit.prevent='updateSliderPrestasi()' @else wire:submit.prevent='addSliderPrestasi()' @endif>
                  <div class="modal-body">
                      @if ($updateSliderPrestasiMode)
                      <input type="hidden" wire:model='selected_sliderprestasi_id'>
                      @endif
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="storage/images/album/slider/prestasi/{{ $oldImg}}" alt="" style="width: 200px">
                        </div>
                        @endif
                        @if ($img)
                        <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="example-text-input"
                            placeholder="Enter action" wire:model='action_title'>
                  ...
                  <div class="modal-footer">
                      ...
                      <button type="submit" class="btn btn-primary w-50 mt-2">
                          {{$updateSliderPrestasiMode ? 'Update':'Save'}}
                      </button>
                  </div>
              </form>
          </div>
