<div>
        ...
        <div class="page-wrapper">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-auto ms-auto d-print-none">
                    <div class="d-flex">
                      ...
                      <a href="{{ route('admin.add-foto') }}" class="btn btn-primary"
                      type="button">
            ...
            <div class="page-body">
              <div class="container-xl">
                    ...
                    <div class="card card-sm">
                      ...
                      <div class="card-body">
                        <div class="d-flex align-items-center">
                          <div class="ms-auto">
                            <a wire:click.prevent='deleteFoto({{$foto->id}})' href="" class="btn  btn-danger mt-1 mb-1">
                                Delete
                            </a>
                          </div>
                        </div>
                ...
                <div class="d-flex">
                    {{$fotos->links('livewire-pagination-links')}}
                </div>
              </div>
            </div>
            {{-- end --}}
    ...
    <div class="modal-dialog  modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="modal-content" method="POST" @if ($updateFotoMode)
