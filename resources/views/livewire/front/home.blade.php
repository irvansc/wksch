                    ...
                    <div class="video-wrapper" data-aos="fade-right">
                        <div class="embed-responsive embed-responsive-16by9">
                            ...
                            <iframe class="embed-responsive-item"
                                src="https://www.youtube.com/embed/mCaMibzEtrI?si=cNnQJwrxMMZojoTa"></iframe>
                            @else
                            <iframe class="embed-responsive-item" src="{{ kepSek()->video_url }}"></iframe>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div id="customers-testimonials" class="owl-carousel">
                        ...
                        <div class="item">
                            <div class="shadow-effect">
                                <img class="img-circle" src="{{ $item->img }}" alt="">
                                <p>
                                    {{$item->desc}}
                                </p>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="bot-gal h-vid ho-event-mob-bot-sp" data-aos="fade-up">
                        ...
                        <iframe src="{{ $item->url_video }}" allowfullscreen></iframe>
                        @endforeach
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="media">
                                ...
                                <div class="media-body recent">
                                    <h5 class="mt-0"><a href="{{ route('read_post', $item->slug) }}">{{
                                            Str::limit($item->post_title, 25, '...') }}</a></h5>
                                    <h6>
