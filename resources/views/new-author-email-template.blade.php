                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-font-size"
                                                                ...
                                                                <ul>
                                                                    <li style="line-height: 19.6px;">Email : {{ $email }}
                                                                    </li>
                                                                    <li style="line-height: 19.6px;">Username :
                                                                        {{ $username }}</li>
                                                                    <li style="line-height: 19.6px;">Password :
                                                                        {{ $password }}</li>
                                                                </ul>
                                                                <p style="line-height: 140%;">Silahkan login untuk
                                                                    meilhat profile anda.</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;">Terimakasih</p>
                                                                <p style="line-height: 140%;">Admin -</p>
                                                                <p style="line-height: 140%;"> </p>
                                                                <p style="line-height: 140%;"> </p>
                                                            </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div align="center">
                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:37px; v-text-anchor:middle; width:84px;" arcsize="11%"  stroke="f" fillcolor="#3AAEE0"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
                                                                <a href="{{$url}}" target="_blank"
                                                                    class="v-button v-button-colors v-font-size"
                                                                    ...
                                                                    <span
                                                                        style="display:block;padding:10px 20px;line-height:120%;"><span
                                                                            style="line-height: 16.8px;">LOGIN</span></span>
                                                                </a>
                                                                    ...
                                                                    <table align="left" border="0" cellspacing="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="{{ webSosmed()->bsm_instagram }}"
                                                                                        title="Instagram"
                                                                                        target="_blank">
                                                                    ...
                                                                    <table align="left" border="0" cellspacing="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="{{ webSosmed()->bsm_twitter }}" title="X"
                                                                                        target="_blank">
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="32" height="32" viewBox="0 0 50 50">
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-font-size"
                                                                ...
                                                                <p style="line-height: 140%;"><sub>{{webInfo()->web_alamat}}</sub></p>
                                                            </div>
