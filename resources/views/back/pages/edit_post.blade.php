...
<form action="{{ route('admin.posts.update-post',['post_id'=>request('post_id')]) }}" method="POST" id="editFormPost"
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{$post->meta_desc}}" type="text" class="form-control" name="meta_desc" placeholder="Enter meta desc">
                        <span class="text-danger error-text meta_desc_error"></span>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Meta Keywords</label>
                        <input value="{{$post->meta_keywords}}" type="text" class="form-control" name="meta_keywords" placeholder="Enter meta keywords">
        ...
        $.ajax({
            ...
            , success: function(response) {
                ...
                if (response.code == 1) {
                    ...
                    var redirectUrl = "{{ route('admin.posts.all_posts') }}";
