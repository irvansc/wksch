...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Import Guru')
@section('pageHeader')
...
<div class="col-md-8">
    <div class="card card-box">
        <div class="card-header">
            <div class="clearfix">
                    <div class="pull-right ">
                        <a href="{{ route('admin.import-templateguru')}}" class="btn btn-success"
                        >
                         Download Template
                    </a>
                    </div>
        ...
        <div class="card-body">
            <form action="{{ route('admin.import-guru') }}" method="POST" enctype="multipart/form-data" id="form-import" needs-validation
            novalidate accept-charset="UTF-8">
                ...
                <div class="mt-3 d-flex justify-content-between">
                    <a href="{{ route('admin.guru') }}"  class="btn btn-warning"> Cancel</a>
